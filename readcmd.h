...
- "ls -l" : seq[0][0] = "ls", seq[0][1] = "-l", seq[0][2] = NULL, seq[1] = NULL, backgrounded =
...
- "sleep 100 &" : seq[0][0] = "sleep", seq[0][1] = "20",  backgrounded != NULL, in = NULL, out =
NULL */
...
struct cmdline {
    ...
    char **
        *seq; /* Une ligne de commande est une suite de commandes liées par des tubes
               * Ainsi,
